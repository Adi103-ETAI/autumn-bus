...
Building Autumn Bus from source requires Go 1.25 or newer.
...
Autumn Bus is harness-independent, not tied to Codex. Use the included configurations for [Codex](adapters/codex), [Claude Code](adapters/claude-code), [Cursor](adapters/cursor), and [OpenCode](adapters/opencode), or connect another MCP-capable harness through the [shared stdio bridge](adapters/README.md).
