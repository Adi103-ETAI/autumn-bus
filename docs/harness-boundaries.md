...
The [adapter directory](../adapters/README.md) contains implemented experimental candidates. [Issue #62](https://github.com/Adi103-ETAI/autumn-bus/issues/62) remains the authoritative target tracker; this document describes boundaries, not another compatibility catalog.
