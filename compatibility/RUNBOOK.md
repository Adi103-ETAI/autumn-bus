...
Use this runbook to exercise a released harness and adapter through public Autumn Bus interfaces. Run it on a clean machine for every platform listed in the evidence record.

## Setup

1. Install the Autumn Bus release being tested.
