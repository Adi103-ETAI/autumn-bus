...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#48](https://github.com/Adi103-ETAI/autumn-bus/issues/48).
...
```sh
autumn-bus harness config antigravity --scope my-project --agent antigravity-reviewer --name "Antigravity Reviewer"
autumn-bus doctor --harness antigravity --scope my-project
```
