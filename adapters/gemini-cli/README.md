...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#38](https://github.com/Adi103-ETAI/autumn-bus/issues/38).
...
```sh
autumn-bus harness config gemini-cli --scope my-project --agent gemini-cli-reviewer --name "Gemini CLI Reviewer"
autumn-bus doctor --harness gemini-cli --scope my-project
```
