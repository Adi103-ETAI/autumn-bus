...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#31](https://github.com/Adi103-ETAI/autumn-bus/issues/31).
...
```sh
autumn-bus harness config hermes --scope my-project --agent hermes-reviewer --name "Hermes Agent Reviewer"
autumn-bus doctor --harness hermes --scope my-project
```
