...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#53](https://github.com/Adi103-ETAI/autumn-bus/issues/53).
...
```sh
autumn-bus harness config autohand --scope my-project --agent autohand-reviewer --name "Autohand Reviewer"
autumn-bus doctor --harness autohand --scope my-project
```
