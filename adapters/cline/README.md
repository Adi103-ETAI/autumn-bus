...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#43](https://github.com/Adi103-ETAI/autumn-bus/issues/43).
...
```sh
autumn-bus harness config cline --scope my-project --agent cline-reviewer --name "Cline Reviewer"
autumn-bus doctor --harness cline --scope my-project
```
