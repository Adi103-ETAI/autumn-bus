...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#59](https://github.com/Adi103-ETAI/autumn-bus/issues/59).
...
```sh
autumn-bus harness config mistral-vibe --scope my-project --agent mistral-vibe-reviewer --name "Mistral Vibe Reviewer"
autumn-bus doctor --harness mistral-vibe --scope my-project
```
