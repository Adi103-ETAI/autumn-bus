...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#51](https://github.com/Adi103-ETAI/autumn-bus/issues/51).
...
```sh
autumn-bus harness config auggie --scope my-project --agent auggie-reviewer --name "Auggie Reviewer"
autumn-bus doctor --harness auggie --scope my-project
```
