...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#54](https://github.com/Adi103-ETAI/autumn-bus/issues/54).
...
```sh
autumn-bus harness config copilot-cli --scope my-project --agent copilot-cli-reviewer --name "GitHub Copilot CLI Reviewer"
autumn-bus doctor --harness copilot-cli --scope my-project
```
