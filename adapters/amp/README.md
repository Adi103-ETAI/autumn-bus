...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#46](https://github.com/Adi103-ETAI/autumn-bus/issues/46).
...
```sh
autumn-bus harness config amp --scope my-project --agent amp-reviewer --name "Amp Reviewer"
autumn-bus doctor --harness amp --scope my-project
```
