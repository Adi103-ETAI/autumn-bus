...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#37](https://github.com/Adi103-ETAI/autumn-bus/issues/37).
...
```sh
autumn-bus harness config claude-code --scope my-project --agent claude-code-reviewer --name "Claude Code Reviewer"
autumn-bus doctor --harness claude-code --scope my-project
```
