...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#44](https://github.com/Adi103-ETAI/autumn-bus/issues/44).
...
```sh
autumn-bus harness config qwen-code --scope my-project --agent qwen-code-reviewer --name "Qwen Code Reviewer"
autumn-bus doctor --harness qwen-code --scope my-project
```
