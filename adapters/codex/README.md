...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#36](https://github.com/Adi103-ETAI/autumn-bus/issues/36).
...
```sh
autumn-bus harness config codex --scope my-project --agent codex-reviewer --name "Codex Reviewer"
autumn-bus doctor --harness codex --scope my-project
```
