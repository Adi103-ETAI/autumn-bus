...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#57](https://github.com/Adi103-ETAI/autumn-bus/issues/57).
...
```sh
autumn-bus harness config kiro --scope my-project --agent kiro-reviewer --name "Kiro Reviewer"
autumn-bus doctor --harness kiro --scope my-project
```
