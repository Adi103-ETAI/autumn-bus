...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#60](https://github.com/Adi103-ETAI/autumn-bus/issues/60).
...
```sh
autumn-bus harness config factory-droid --scope my-project --agent factory-droid-reviewer --name "Factory Droid Reviewer"
autumn-bus doctor --harness factory-droid --scope my-project
```
