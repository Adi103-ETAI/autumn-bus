...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-11; no named-harness versions or platforms certified for this revision. Refs [#30](https://github.com/Adi103-ETAI/autumn-bus/issues/30).
...
```sh
autumn-bus harness config grok --scope my-project --agent grok-reviewer --name "Grok Reviewer"
autumn-bus doctor --harness grok --scope my-project
```
