...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#50](https://github.com/Adi103-ETAI/autumn-bus/issues/50).
...
```sh
autumn-bus harness config goose --scope my-project --agent goose-reviewer --name "Goose Reviewer"
autumn-bus doctor --harness goose --scope my-project
```
