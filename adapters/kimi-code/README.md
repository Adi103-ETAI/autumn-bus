...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#45](https://github.com/Adi103-ETAI/autumn-bus/issues/45).
...
```sh
autumn-bus harness config kimi-code --scope my-project --agent kimi-code-reviewer --name "Kimi Code Reviewer"
autumn-bus doctor --harness kimi-code --scope my-project
```
