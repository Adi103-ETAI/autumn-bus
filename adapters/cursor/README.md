...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#33](https://github.com/Adi103-ETAI/autumn-bus/issues/33).
...
```sh
autumn-bus harness config cursor --scope my-project --agent cursor-reviewer --name "Cursor Reviewer"
