...
Status: experimental, adapter 0.2.0. Configuration reviewed on 2026-09-10; no named-harness versions or platforms certified for this revision. Refs [#56](https://github.com/Adi103-ETAI/autumn-bus/issues/56).
...
```sh
autumn-bus harness config crush --scope my-project --agent crush-reviewer --name "Crush Reviewer"
autumn-bus doctor --harness crush --scope my-project
```
