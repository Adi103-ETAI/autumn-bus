...
test('promotion accepts only successful reviewed-lane main artifacts from the same repository', () => {
  const run = { head_repository: { full_name: 'Adi103-ETAI/autumn-bus' }, head_branch: 'main', path: '.github/workflows/publish-npm-prerelease.yml', event: 'workflow_dispatch', status: 'completed', conclusion: 'success', head_sha: 'a'.repeat(40) }
