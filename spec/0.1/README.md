# Autumn Bus protocol 0.1

Status: draft

Autumn Bus is a communication and coordination protocol for AI agents and harnesses. It defines identity, discovery, durable messages, shared tasks, and human escalation. It does not select agents, staff teams, route models, or supervise an overall operation.
...
An A2A Task and an Autumn Bus shared task are different resources. An A2A Task represents one remote delegated interaction. A Bus shared task is work that any eligible agent can claim.
